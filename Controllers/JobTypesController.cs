...
namespace CLDV_Framework.Controllers
{
    public class JobTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "JobTypeID,JobType1,Rate")] JobType jobType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JobTypeID,JobType1,Rate")] JobType jobType)
        {
            if (ModelState.IsValid)
            {
